...
z_wall1 = buffer_l
z_wall2 = buffer_l + central_z
box_z = 2*buffer_l + central_z
...
#===========================
if useNPT:
    system.addForce(openmm.MonteCarloAnisotropicBarostat(3*[pressure],temperature,False,False,True,barostatInterval))
